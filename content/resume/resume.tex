...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Built backend system and wrote all APIs for a revamped Help Center, \textbf{15,000+ daily active users}}
        \resumeItem{Integrated with internal tools for searchability of content, \textbf{reduced customer support time by 25\%}}
        \resumeItem{Worked with Java, Spring Framework, and AWS in the backend, TypeScript and React in the frontend}
    \resumeItemListEnd
